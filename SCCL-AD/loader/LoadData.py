...
def load_data(data_name,cls,cls_type):
    ...
    if data_name == 'thyroid':
        ...
        train, train_label, test, test_label = smd_train_test_split(data_path)
    elif data_name == 'smap':
        train, train_label, test, test_label = smap_train_test_split(data_path)
    elif data_name == 'msl':
        train, train_label, test, test_label = msl_train_test_split(data_path)
    elif data_name == 'psm':
        train, train_label, test, test_label = psm_train_test_split(data_path)
    elif data_name == 'wadi':
        train, train_label, test, test_label = wadi_train_test_split(data_path)
    elif data_name == 'swat':
        train, train_label, test, test_label = swat_train_test_split(data_path)
