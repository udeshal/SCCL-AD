...
class runExperiment():
    ...
    def run_test(self, dataset, logger):
        ...
        val_loss,val_auc,test_auc,test_ap,test_f1,test_afff1,test_paf1,train_time_per_epoch,test_infer_time,train_peak_mem_gb,test_peak_mem_gb,scores,labels = \
        ...
        return val_auc, test_auc, test_ap,test_f1,test_afff1,test_paf1,train_time_per_epoch,test_infer_time,train_peak_mem_gb,test_peak_mem_gb,scores,labels
